...
<head>
<meta charset="EUC-KR">
<title>InputDeleteBecause</title>
<script src="./js/jquery-3.6.4.js"></script>
<script src="./js/inputBec.js"></script>
<link rel="stylesheet" type="text/css" href="./css/inputBec.css" />
</head>
<body>
<div class="top">
        <div id="music_player">
...
<c:choose>
	...
	<section class="inputBecBox">
		<form action="deletePriv.do" method="post">
			<table id="inputBecTable">
				<caption id="inputBec_caption">삭제 사유 적는 곳</caption>
				<tr>
					<td id="index">※ 어떤 사유로 인해 해당 게시글을 삭제하는지 적어주세요 ※</td>
				</tr>
				<tr>
					<td><textarea rows="30" cols="70" id="bOpnion" required name="because"/></textarea></td>
				</tr>
				<tr>
					<td>&nbsp;<input type="submit" id="becSubmitBtn" /></td>
				</tr>
