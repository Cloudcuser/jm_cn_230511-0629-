...
<section class="whole">  
        <div>     
            <img id="backgroundImg" alt="#" src="./image_src/joinToCafe/beach-ga885d0fde_1920.jpg" />
        </div>
  	</section>
    <div class="top">        
            <div id="gnl">
    ...
    <section class="join_window">
			...
			<table id="findIdTable">
				...
				<tr>
					<td>별명</td>
					<td><input type="text" name="nName" id="nName" placeholder="별명" required /></td>
				</tr>		
				<tr>
					<td>계정 찾기 질문</td>
					<td>			
				...
				<tr>
					...
					<td colspan="2">
						<a href="cafe_findPw.jsp"><input type="button" value="비밀번호 찾기" /></a>
